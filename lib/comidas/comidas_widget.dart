...
import 'comidas_model.dart';
export 'comidas_model.dart';

class ComidasWidget extends StatefulWidget {
  const ComidasWidget({Key? key}) : super(key: key);

  @override
  _ComidasWidgetState createState() => _ComidasWidgetState();
}

class _ComidasWidgetState extends State<ComidasWidget> {
  late ComidasModel _model;
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  7.0, 2.0, 0.0, 0.0),
                                          child: Text(
                                            'Taquitos de Frijoles con Cilantro y Hummus de Haba',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Raleway',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  7.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'tacos veganos con champiñones adobados',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Raleway',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  7.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'Espagueti a la boloñesa vegano',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Raleway',
